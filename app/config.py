...
class Settings(BaseSettings):
    ...
    # SMTP Configuration
    EMAIL_HOST: str  # Must be set in .env
    EMAIL_PORT: int  # Must be set in .env
    EMAIL_USERNAME: str = None # Must be set in .env
    EMAIL_PASSWORD: str = None  # Must be set in .env
